  ...
  <div class="col-lg-12">
    ...
    <table width="100%">
      ...
      <tr>
        ...
        <td>
          <?php echo date("d/m/Y", strtotime($data[0]['book_enddate'])); ?>
          &nbsp;&nbsp;&nbsp;&nbsp;/&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <tr>
        ...
        foreach ($data_food as $f) {
          ...
          <td width=130px> = ".number_format($f['food_unit']*$f['food_price'])." บาท</td> 
          <td>
      ...
      <tr>
        ...
        foreach ($data_dessert as $d) {
          ...
          <td width=130px> = ".number_format($d['food_unit']*$d['dessert_price'])." บาท</td> 
          <td>
      ...
      <tr>
        <td colspan="3" align="right">
          <label>
            ...
            <input type="hidden" name="level" value="mg_hr">
